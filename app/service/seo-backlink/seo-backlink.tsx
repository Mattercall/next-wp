...
const features = [
  {
    tag: "AUTHORITY LINKS",
    title: "Dofollow links from trusted, relevant sites",
    description:
      "MatterCall earns placements on vetted publications that lift domain authority.",
    image:
      "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=900&q=80",
  },
  {
    tag: "TRAFFIC LIFT",
    title: "Referral visits that amplify organic growth",
    description:
      "We prioritize placements that send qualified clicks alongside ranking gains.",
    image:
      "https://images.unsplash.com/photo-1523475472560-d2df97ec485c?auto=format&fit=crop&w=900&q=80",
  },
  {
    tag: "SAFE OUTREACH",
    title: "White-hat backlink acquisition you can trust",
    description:
      "No spam, no PBNs—just editorial outreach and brand-safe partnerships.",
    image:
      "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=900&q=80",
  },
  {
    tag: "TRANSPARENT REPORTING",
    title: "See every link and the impact it delivers",
    description:
      "Track live URLs, anchor text, and traffic movement with clear reporting.",
    image:
...
const faqs = [
  "How quickly will backlinks influence rankings?",
  "Do you provide only dofollow backlinks?",
  "Can you target specific pages and keywords?",
  "How do you verify link quality and safety?",
];
...
export default function SeoBacklinkLanding() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("/api/seo-backlink-lead", {
        method: "POST",
        headers: {
              ...
              <div className="grid h-full w-full grid-cols-4 gap-6 opacity-90">
                {heroImages.map((image, index) => (
                  ...
                  >
                    <img
                      src={image}
                      alt="MatterCall backlink campaign collage"
                      className="h-full w-full object-cover"
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col items-center px-4">
          <div className="mt-6 w-full max-w-md rounded-3xl bg-white/95 p-8 text-center shadow-[0_20px_60px_rgba(0,0,0,0.18)] backdrop-blur">
            ...
            <h1 className="mt-4 text-balance text-3xl font-semibold text-neutral-900 sm:text-4xl">
              Dofollow backlinks that push rankings and traffic higher
            </h1>
            <p className="mt-3 text-sm text-neutral-500">
              Build authority with vetted links that boost SEO visibility and
              send qualified visitors.
            </p>
            <StartForFreeBar
              className="mt-6"
              variant="dark"
      ...
      <section className="bg-background py-16 sm:py-20">
        <div className="mx-auto max-w-4xl px-4">
          <blockquote className="text-2xl font-semibold text-neutral-900 sm:text-3xl">
            “MatterCall delivered backlinks that lifted our rankings and
            doubled qualified traffic within weeks.”
          </blockquote>
        ...
        <div className="mx-auto max-w-5xl px-4">
          <div className="rounded-3xl bg-gradient-to-br from-[#3b0fb8] via-[#4512c4] to-[#2b088f] px-6 py-12 text-center text-white shadow-[0_30px_80px_rgba(35,8,112,0.4)] sm:px-12">
            ...
            <h2 className="mt-6 text-2xl font-semibold sm:text-3xl">
              Turn search visibility into steady demand.
              <br />
              Start with a MatterCall backlink sprint.
            </h2>
                ...
                <div key={question} className="py-5">
                  ...
                  >
                    <div className="overflow-hidden">
                      <p className="mt-3 text-sm text-neutral-500">
                        We map your goals, build a backlink target list, and
                        execute white-hat outreach that grows authority and
                        traffic.
                      </p>
                    </div>
                  </div>
